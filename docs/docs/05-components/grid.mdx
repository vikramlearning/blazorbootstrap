...
| SummaryValuePrefix | string | null | | Gets or sets the summary value prefix. If set, it will be displayed before the summary value. Otherwise, based on the <see cref="SummaryType"/>, default prefix will be displayed. To remove the default prefix, set this property to an empty string. | 3.4.0 |
...
<img src="https://i.imgur.com/nUodoAa.png" alt="Blazor Bootstrap: Grid Component - Default selection" />
...
[See demo here](https://demos.blazorbootstrap.com/grid/selection#default-selection)
...
<img src="https://i.imgur.com/opicd0P.png" alt="Blazor Bootstrap: Grid Component - Select all or unselect all programmatically" />
...
[See demo here](https://demos.blazorbootstrap.com/grid/selection#select-all-or-unselect-all-programmatically)
...
Enum filter labels use `DisplayAttribute.GetName()` when a `DisplayAttribute` is present, including resource-backed names, and fall back to the enum member name when no display metadata exists.
...
```cshtml {1,44,47-57} showLineNumbers
