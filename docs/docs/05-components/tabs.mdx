...
| NavStyle | `NavStyle` | `NavStyle.Tabs` | | Get or sets the nav style. | 1.0.0 |
...
| Content | RenderFragment | null | ✔️ | Gets or sets the content to be rendered within the component. | 1.0.0 |
...
<img src="https://i.imgur.com/0UUggZl.png" alt="Blazor Tabs Component - Remove inactive tab" />
