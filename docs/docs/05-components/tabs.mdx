...
| Event | Description | Added Version |
|:--|:--|:--|
| OnTabClicked | This event fires when the user clicks the corresponding tab button and the tab is displayed. | 1.11.0 |
...
### Tab call back event: OnTabClicked
...
[See demo here.](https://demos.blazorbootstrap.com/tabs#tab-callback-event-on-tab-clicked)
