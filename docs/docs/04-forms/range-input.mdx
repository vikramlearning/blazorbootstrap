...
|:--|:--|:--|:--|:--|
| Disabled | bool | false | | Disables or enables the range input. |
| Max| TValue | | | Gets or sets the maximum value of the range input. |
| Min| TValue | | | Gets or sets the minimum value of the range input. |
| Step | double | 1 | | Gets or sets the step value of the range input. |
| TickMarks | `IEnumerable<TickMark>` | `default` | | Gets or sets the tick marks. |
| Value | TValue | | | Gets or sets the value of the range input. |

## Methods

| Name | Description |
|:--|:--|
| Disable() | Disables range input. |
| Enable() | Enables range input. |
