...
|:--|:--|:--|:--|:--|:--|
| AutoComplete | bool | false | | If true, DateInput can complete the values automatically by the browser. | 1.5.0 |
| Disabled | bool | false | | Gets or sets the disabled state. | 1.5.0 |
...
| Max| TValue | | | Gets or sets the max. Max ignored if EnableMinMax="false". Allowed format is yyyy-mm-dd. | 1.5.0 |
| Min| TValue | | | Gets or sets the min. Min ignored if EnableMinMax="false". Allowed format is yyyy-mm-dd. | 1.5.0 |
