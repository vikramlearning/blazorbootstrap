...
|:--|:--|:--|:--|:--|:--|
| AutoComplete | bool | false | | If true, DateInput can complete the values automatically by the browser. | 1.6.0 |
| Disabled | bool | false | | Gets or sets the disabled state. | 1.6.0 |
