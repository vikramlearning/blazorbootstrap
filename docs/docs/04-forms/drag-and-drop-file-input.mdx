...
<img src="https://demos.blazorbootstrap.com/_content/BlazorBootstrap.Demo.RCL/images/screenshots/drag-and-drop-file-input.png" alt="Blazor Bootstrap DragAndDropFileInput component" />
...
[See demo here](https://demos.blazorbootstrap.com/demos/form/drag-and-drop-file-input#basic-usage)
...
[See demo here](https://demos.blazorbootstrap.com/demos/form/drag-and-drop-file-input#validation)
...
`DragAndDropFileInput` participates in an `EditForm` and retains the same validation behavior whether files are dropped or selected through the native picker.

[See demo here](https://demos.blazorbootstrap.com/demos/form/drag-and-drop-file-input#form-validation)
