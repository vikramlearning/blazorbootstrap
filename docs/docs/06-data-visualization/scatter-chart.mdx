...
| Interaction | `Interaction` | | | Gets or sets the Interaction. | 3.0.0 |
| Layout | `ChartLayout` | | | Gets or sets the ChartLayout. | 3.0.0 |
...
| Plugins | `ScatterChartPlugins` | | | Gets or sets the Plugins. | 3.0.0 |
...
| Scales | `Scales` | | | Gets or sets the Scales. | 3.0.0 |
...
| Intersect | bool | true | | If true, the interaction mode only applies when the mouse position intersects an item on the chart. | 3.0.0 |
| Mode | `InteractionMode` | `Nearest` | | Sets which elements appear in the interaction. | 3.0.0 |
