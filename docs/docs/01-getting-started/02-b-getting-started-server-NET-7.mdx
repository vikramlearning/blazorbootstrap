---
id: blazor-server-net-7
sidebar_label: Blazor Server (.NET 7)
sidebar_position: 6
title: Blazor Server (.NET 7)
---
...
After the `<base href="~/" />` tag in the `head` section in the **Pages/_Host.cshtml**.
...
1. Remove the following line from **Pages/_Host.cshtml** file:
...
[GitHub Repo: Blazor Bootstrap - Blazor Server App (.NET 7)](https://github.com/vikramlearning/blazorbootstrap-starter-templates/tree/master/src/BlazorBootstrap.Templates.Starter/NET7.BlazorServerApp)
...
```cshtml {12-14,35-40} showLineNumbers
@page "/"
