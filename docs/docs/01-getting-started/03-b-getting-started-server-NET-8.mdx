...
# Getting started - Blazor Web App (.NET 8) - Interactive render mode Server - Global location
...
[GitHub Repo: Blazor Bootstrap - Blazor Web App - Interactive Render Mode Server - Global (.NET 8)](https://github.com/vikramlearning/blazorbootstrap-starter-templates/tree/master/src/BlazorBootstrap.Templates.Starter/NET8.BlazorWebAppRenderModeServerGlobal)
