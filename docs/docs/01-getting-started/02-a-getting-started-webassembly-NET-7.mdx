...
[GitHub Repo: Blazor Bootstrap - Blazor WebAssembly App (.NET 7)](https://github.com/vikramlearning/blazorbootstrap-starter-templates/tree/master/src/BlazorBootstrap.Templates.Starter/NET7.BlazorWebAssemblyApp)
...
```html {9-11,33-35} showLineNumbers
<!DOCTYPE html>
<html lang="en">
