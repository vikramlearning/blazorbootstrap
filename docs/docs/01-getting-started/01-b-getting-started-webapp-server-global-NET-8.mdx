---
id: blazor-webapp-server-global-net-8
sidebar_label: Blazor WebApp Server (.NET 8)
sidebar_position: 2
title: Blazor WebApp Server (.NET 8)
---
...
[GitHub Repo: Blazor Bootstrap - Blazor Web App - Interactive Render Mode Server - Global (.NET 8)](https://github.com/vikramlearning/blazorbootstrap-starter-templates/tree/master/src/BlazorBootstrap.Templates.Starter/NET8.BlazorWebAppRenderModeServer)
