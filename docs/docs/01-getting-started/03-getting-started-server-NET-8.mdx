...
:::danger IMPORTANT
In .NET 6 Blazor Server App default template, you may see **Components/App.razor**. So, add these references in the **Pages/_Layout.cshtml** instead of in the **Pages/_Host.cshtml**.
:::
...
Delete the default **bootstrap** folder from the **wwwroot** folder.
...
1. [Blazor Bootstrap - Blazor Web App - Interactive Render Mode - Server](https://github.com/vikramlearning/blazorbootstrap-starter-templates/tree/master/src/BlazorBootstrap.Templates.Starter/NET6.BlazorServerApp)
