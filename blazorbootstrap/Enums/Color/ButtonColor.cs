...
/// <summary>
/// Defines the supported visual color options for a BlazorBootstrap button.
/// </summary>
public enum ButtonColor
{
    ...
    /// <summary>
    /// Indicates a link-like visual style option.
    /// </summary>
    [AddedVersion("1.0.0")]
    [Description("Indicates a link-like visual style option.")]
    Link
}
