...
public class BlazorBootstrapChart : BlazorBootstrapComponentBase, IDisposable, IAsyncDisposable
{
    ...
    /// <summary>
    /// Update chart by reapplying all chart data and options. If animation is enabled, this will animate the datasets from
    /// scratch.
    /// </summary>
    /// <param name="chartData"></param>
    /// <param name="chartOptions"></param>
    ...
    /// <summary>
    /// Update only data labels and values. If animation is enabled, this will animate the datapoints from their previous
    /// values, but changes to the options will not be applied.
    /// </summary>
