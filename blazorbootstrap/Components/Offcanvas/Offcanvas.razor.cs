...
public partial class Offcanvas : BaseComponent
{
    ...
    /// Shows an offcanvas.
    /// </summary>
    public async Task ShowAsync() => await ShowAsync(title: null, type: null, parameters: null);
    ...
    public async Task ShowAsync<T>(string title, Dictionary<string, object>? parameters = null) => await ShowAsync(title: title, type: typeof(T), parameters: parameters);
