...
public partial class Sidebar3Item : BlazorBootstrapComponentBase
{
    ...
    public Sidebar3NavItem Item { get; set; } = new();
    ...
    [CascadingParameter] public Sidebar3 Parent { get; set; } = default!;
