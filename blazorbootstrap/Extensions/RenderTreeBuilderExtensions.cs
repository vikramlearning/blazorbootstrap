...
public static class RenderTreeBuilderExtensions
{
    ...
    public static RenderTreeBuilder AriaDisabled(this RenderTreeBuilder builder, object value, [CallerLineNumber] int line = 0) => Aria(builder, "disabled", value, line);

    public static RenderTreeBuilder AriaHidden(this RenderTreeBuilder builder, object value, [CallerLineNumber] int line = 0) => Aria(builder, "hidden", value, line);

    public static RenderTreeBuilder AriaLabel(this RenderTreeBuilder builder, object value, [CallerLineNumber] int line = 0) => Aria(builder, "label", value, line);

    public static RenderTreeBuilder AriaPressed(this RenderTreeBuilder builder, bool value, [CallerLineNumber] int line = 0)
    {
        if (value) return Aria(builder, "pressed", "true", line);
    ...
    {
        if (!string.IsNullOrEmpty(value)) builder.AddAttribute(line, "class", value);
    ...
    {
        builder.AddAttribute(line, "onclick", EventCallback.Factory.Create<MouseEventArgs>(receiver, callback));
    ...
    {
        if (!string.IsNullOrEmpty(value)) builder.AddAttribute(line, "style", value);
    ...
    {
        if (target != BlazorBootstrap.Target.None) builder.AddAttribute(line, "target", target.ToTargetString());
