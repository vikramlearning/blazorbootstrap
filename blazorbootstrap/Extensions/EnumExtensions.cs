...
public static class EnumExtensions
{
    ...
    /// <returns>string</returns>
    public static string ToButtonTagName(this ButtonType buttonType) => buttonType switch { ButtonType.Link => "a", _ => "button" };
    ...
    /// <param name="buttonType"></param>
    /// <returns>string</returns>
    public static string ToButtonTypeString(this ButtonType buttonType) => buttonType switch { ButtonType.Button => "button", ButtonType.Submit => "submit", ButtonType.Reset => "reset", _ => null };
    ...
    /// <returns>string</returns>
    public static string ToCalloutColor(this CalloutType calloutColor) => calloutColor switch { CalloutType.Default => "", CalloutType.Danger => "bb-callout-danger", CalloutType.Warning => "bb-callout-warning", CalloutType.Info => "bb-callout-info", _ => "" };
    ...
    /// <returns>string</returns>
    public static string ToTargetString(this Target target) => target switch { Target.Blank => "_blank", Target.Parent => "_parent", Target.Top => "_top", Target.Self => "_self", _ => null };
    ...
    /// <returns>string</returns>
    public static string ToTooltipPlacementName(this TooltipPlacement tooltipPlacement) => tooltipPlacement switch { TooltipPlacement.Auto => "auto", TooltipPlacement.Right => "right", TooltipPlacement.Bottom => "bottom", TooltipPlacement.Left => "left", _ => "top" };
