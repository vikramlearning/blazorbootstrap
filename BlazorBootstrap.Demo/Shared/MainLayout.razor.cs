...
public partial class MainLayout : LayoutComponentBase
{
    ...
    private IEnumerable<NavItem> GetNavItems()
    {
        navItems = new List<NavItem>
        {
            ...
            new (){ Id = "506", Text = "Card", Href = "/card", IconName = IconName.StickyFill, ParentId = "5" },
            ...
            new (){ Id = "510", Text = "Dropdown", Href = "/dropdown", IconName = IconName.QuestionDiamondFill, ParentId = "5" },
