    ...
    private IEnumerable<NavItem> GetNavItems()
    {
        ...
        yield return new()
        {
            ...
            ChildItems = new List<NavItem>
            {
                ...
                new (){ Text = "Pdf Viewer", Href = "/pdf-viewer", IconName = IconName.FilePdfFill },
                ...
                new (){ Text = "Script Loader", Href = "/script-loader", IconName = IconName.CodeSlash },
                new (){ Text = "Sidebar", Href = "/sidebar", IconName = IconName.LayoutSidebar },
                new (){ Text = "Spinner", Href = "/spinners", IconName = IconName.ArrowRepeat },
