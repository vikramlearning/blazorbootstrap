...
- Install with [NuGet](https://www.nuget.org/): `Install-Package Blazor.Bootstrap -Version 1.8.3`
- Install [Blazor Bootstrap templates](https://github.com/vikramlearning/blazorbootstrap-project-templates) with **.NET CLI**: `dotnet new install Blazor.Bootstrap.Templates::1.8.3`
